...
INSERT INTO registrations (event_id, dancer_id, competition_id, competitor_number, status) VALUES
  ...
  ('11111111-1111-1111-1111-111111111111', 'dddd3333-3333-3333-3333-333333333333', 'cccc2222-2222-2222-2222-cccc22222222', '201', 'present'),
  ('11111111-1111-1111-1111-111111111111', 'dddd6666-6666-6666-6666-666666666666', 'cccc2222-2222-2222-2222-cccc22222222', '202', 'present'),
  ('11111111-1111-1111-1111-111111111111', 'dddd7777-7777-7777-7777-777777777777', 'cccc2222-2222-2222-2222-cccc22222222', '203', 'present'),
  ('11111111-1111-1111-1111-111111111111', 'dddd8888-8888-8888-8888-888888888888', 'cccc2222-2222-2222-2222-cccc22222222', '204', 'present'),
  ('11111111-1111-1111-1111-111111111111', 'dddd9999-9999-9999-9999-999999999999', 'cccc2222-2222-2222-2222-cccc22222222', '205', 'present'),
  ('11111111-1111-1111-1111-111111111111', 'dddd1111-1111-1111-1111-111111111111', 'cccc3333-3333-3333-3333-cccc33333333', '301', 'registered'),
  ('11111111-1111-1111-1111-111111111111', 'dddd6666-6666-6666-6666-666666666666', 'cccc3333-3333-3333-3333-cccc33333333', '302', 'registered'),
  ('11111111-1111-1111-1111-111111111111', 'ddddaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'cccc3333-3333-3333-3333-cccc33333333', '303', 'registered'),
  ('11111111-1111-1111-1111-111111111111', 'dddd9999-9999-9999-9999-999999999999', 'cccc3333-3333-3333-3333-cccc33333333', '304', 'registered');
